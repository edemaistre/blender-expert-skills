...
/Users/emmanuel/Developer/pro/2026-09-24 Blender Expert Skills/tests/code/blender-previs-storyboard/test_01_s6_end_to_end.py, test_02_api_traps.py,
test_03_procedures.py and test_04_grading_gates.py (passepartout, fog, coverage runs,
cost gates, Rigify proxies).

  import sys
  sys.path += ["<skills>/blender-previs-storyboard/scripts", "<skills>/blender-expert/scripts"]
...
def gp_carrier(sc, name, parent=None, loc=(0, 0, 0), color=INK):
    ...
    Renato, Pablo). The drawing itself is the blender-grease-pencil skill's job."""
