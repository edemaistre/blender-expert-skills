...
Tested by /Users/emmanuel/Developer/pro/2026-09-24 Blender Expert Skills/tests/code/blender-retopology/test_bx_retopo.py on the Blender Studio sheep sculpt.

    import sys; sys.path.append("<skills>/blender-retopology/scripts"); import bx_retopo as R
