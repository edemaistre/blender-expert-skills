...
- **Grab with topology auto-masking "all the time"**; Grab Silhouette widens one finger without neighbours; Grab 2D moves through the full depth [FDscc66fC90 00:26:04-00:28:16]. On screen: Grab strength 0.4, Pose 0.5 with IK segments 1, smooth iterations 5.
...
- **Features exist only in context**: judge proportions after several features are blocked, and suspect neighbours when one area looks wrong [00:09:00, 00:43:29].
...
- **Move whole features**: mask, remove the mask where it touches neighbours, smooth it, invert, Set Pivot to Unmasked, Scale or Move [00:23:38, 00:33:29].
...
| Symmetry mechanism | Mirror modifier with a centre object (Rain); linked duplicates (Kaspar 2019/2023); mesh symmetry + Symmetrize (Michel, Keelan Jon) | separate posed parts: linked data; one merged mesh: symmetric kernels + `S.symmetrize` after remeshes |
