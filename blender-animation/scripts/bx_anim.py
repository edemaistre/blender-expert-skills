...
(an onion-skin contact image and a graph-editor style curve plot).
  ...
  import sys; sys.path.append("<skills>/blender-animation/scripts"); import bx_anim as A
...
Verified on Blender 5.2.1 LTS headless: /Users/emmanuel/Developer/pro/2026-09-24 Blender Expert Skills/tests/code/blender-animation/test_bx_anim.py,
