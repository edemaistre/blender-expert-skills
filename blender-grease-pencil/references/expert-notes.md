...
Timestamps are `[mm:ss]` into the source video (see `sources.md`). [added] marks my own additions, [verified] a fact checked in Blender 5.2.1 by the tests under `/Users/emmanuel/Developer/pro/2026-09-24 Blender Expert Skills/tests/code/blender-grease-pencil/` or the distiller probes in `/Users/emmanuel/Developer/pro/2026-09-24 Blender Expert Skills/archive/tests/grease_pencil/`, [inferred] an unconfirmed reading.
...
- Line Art "thickness" (Elijah's 60): property is `radius`, in metres, meaning line width [verified].
