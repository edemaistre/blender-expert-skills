...
**REQUIRED BACKGROUND:** blender-expert (execution channel, review loop, 5.2 API changes). Hair node groups (Interpolate, Clump, Curl, Hair Dynamics grooms): blender-hair.
