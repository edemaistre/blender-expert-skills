...
- blender-expert: the router, execution channel and review loop.
- blender-geometry-nodes: general node-group work beyond the hair assets.
- blender-texturing-shading: the head and skin under the groom.
- blender-lighting-rendering: final lighting of hero shots.
- blender-rigging: the deformation the groom has to survive.
