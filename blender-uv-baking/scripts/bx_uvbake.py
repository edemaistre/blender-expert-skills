...
Tested on Blender 5.2.1 LTS (/Users/emmanuel/Developer/pro/2026-09-24 Blender Expert Skills/tests/code/blender-uv-baking/). Facts the code relies on
...
def _review_helpers():
    ...
    root = os.path.join(os.path.dirname(os.path.dirname(here)), "blender-expert", "scripts")
