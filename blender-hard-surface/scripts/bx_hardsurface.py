...
Tested by /Users/emmanuel/Developer/pro/2026-09-24 Blender Expert Skills/tests/code/blender-hard-surface/test_*.py (run with
`blender --background --factory-startup --python-exit-code 1 --python <test>`).

    import sys; sys.path.append("<skills>/blender-hard-surface/scripts"); import bx_hardsurface as HS
...
def transfer_normals(ob, source=None, max_distance=None, mix=1.0, angle=30.0, weighting="AUTO"):
    ...
    Verified in 5.2.1 (/Users/emmanuel/Developer/pro/2026-09-24 Blender Expert Skills/tests/code/blender-hard-surface/test_02_shading_audit.py), normal
...
def game_version(ob, name=None, micro_segments=1, design_segments=None, triangulate=True):
    ...
    against the budget; bake-based routes live in blender-retopology / blender-uv-baking."""
    g = ob.copy()
    g.data = ob.data.copy()
